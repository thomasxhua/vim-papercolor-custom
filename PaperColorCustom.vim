...
" <custom> swap inactive and active
...
"  exec 'hi StatusLineTermNC' . s:fg_statusline_inactive_bg . s:bg_statusline_inactive_fg
  exec 'hi StatusLine' . s:fg_statusline_inactive_bg . s:bg_statusline_inactive_fg
  exec 'hi StatusLineNC' . s:fg_statusline_active_bg . s:bg_statusline_active_fg
  exec 'hi StatusLineTerm' . s:fg_statusline_inactive_bg . s:bg_statusline_inactive_fg
  exec 'hi StatusLineTermNC' . s:fg_statusline_active_bg . s:bg_statusline_active_fg
" </custom>
...
" <custom>
  ...
  exec 'hi TabLine' . s:fg_tabline_active_fg . s:bg_tabline_active_bg . s:ft_none
  exec 'hi TabLineFill' . s:fg_tabline_bg . s:bg_tabline_bg . s:ft_none
  exec 'hi TabLineSel' . s:fg_tabline_inactive_fg . s:bg_tabline_inactive_bg . s:ft_none
" </custom>
...
hi clear
syntax reset
let g:colors_name = "PaperColorCustom"
